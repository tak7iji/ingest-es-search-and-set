...
public class EsSearchAndSetProcessorTests extends ESTestCase {
    ...
    public void testThatProcessorWorks() throws Exception {
        ...
        EsSearchAndSetProcessor processor = new EsSearchAndSetProcessor(randomAsciiOfLength(10), "source_field", "target_field");
